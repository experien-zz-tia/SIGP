panelGestionPasantesTA = Ext.extend(panelGestionPasantesTAUi, {
	initComponent : function() {
		panelGestionPasantesTA.superclass.initComponent.call(this);
	...
	limpiarFiltro : function() {
		...
		stPasantesTA.setBaseParam('pCarreraId', '*');
		stPasantesTA.load();
	},
	actualizarParametro : function() {
		id = Ext.getCmp('cmbCarrera').getValue();
		stPasantesTA.setBaseParam('pCarreraId', id);
		stPasantesTA.load();
	},
	verPerfil : function() {
	...
	verTutor : function() {
		...
		if (!index) {
			...
			var frmVerP = new frmVerDetalleTE({
						renderTo : Ext.getBody()
					});
